...
entry:
  ...
  %5 = call i64 @computeReal(i32 16, i64 %4, i64 0, double %b, double 1.000000e-01, double %mul.le, i32 1)
  ...
  %9 = call i64 @computeReal(i32 12, i64 %5, i64 %8, double %mul.le, double %a, double %add.le, i32 2)
  %10 = select i1 %cmp4, i64 %9, i64 0
...
if.end:                                           ; preds = %entry
  ...
  %1 = call i64 @fpSanLoadFromShadowMem(i8* %0, i32 5)
  ...
  br i1 %cmp343, label %for.cond.cleanup10.loopexit, label %for.cond.cleanup10

for.cond.cleanup10.loopexit:                      ; preds = %if.end
  ...
  %9 = call i64 @getRealReturn(i32 10)
  %add6.le = fadd double %call5.le, 0.000000e+00
  %10 = call i64 @computeReal(i32 12, i64 %9, i64 0, double %call5.le, double 0.000000e+00, double %add6.le, i32 11)
  %11 = add i32 %call1, -1
...
for.cond.cleanup10:                               ; preds = %if.end, %for.cond.cleanup10.loopexit
  %19 = phi i64 [ %10, %for.cond.cleanup10.loopexit ], [ 0, %if.end ]
  %sum.0.lcssa49 = phi double [ %add6.le, %for.cond.cleanup10.loopexit ], [ 0.000000e+00, %if.end ]
  %sum1.0.lcssa = phi i32 [ %18, %for.cond.cleanup10.loopexit ], [ 1, %if.end ]
  %call16 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.2, i64 0, i64 0), double %sum.0.lcssa49)
