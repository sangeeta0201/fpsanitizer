...
commandexe       = gromacs_base.gcc43-64bit
...
log_line_width   = 0
log_timestamp    = 0
logname          = /home/sangeeta/install_archives/result/CPU2006.082.log
lognum           = 082
mach             = default
mail_reports     = all
mailcompress     = 0
...
notes_plat_sysinfo_010 =  running on prof1 Tue Jul 31 13:48:12 2018
...
notes_plat_sysinfo_240 =     /dev/sda3      ext4  1.8T  387G  1.4T  23% /
...
path             = /home/sangeeta/install_archives/benchspec/CPU2006/435.gromacs
plain_train      = 1
power            = 0
preenv           = 1
prefix           = 
...
run              = all
rundir           = run
runspec          = /home/sangeeta/install_archives/bin/runspec --config=mytest.cfg --action=build --tune=base gromacs
safe_eval        = 1
...
srcalt           = 
srcdir           = src
srcsource        = /home/sangeeta/install_archives/benchspec/CPU2006/435.gromacs/src
stagger          = 10
