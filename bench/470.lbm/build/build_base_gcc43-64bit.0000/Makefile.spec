...
commandexe       = lbm_base.gcc43-64bit
...
log_line_width   = 0
log_timestamp    = 0
logname          = /home/sangeeta/install_archives/result/CPU2006.098.log
lognum           = 098
mach             = default
mail_reports     = all
mailcompress     = 0
...
notes_plat_sysinfo_010 =  running on prof1 Sun Aug 12 18:06:18 2018
...
path             = /home/sangeeta/install_archives/benchspec/CPU2006/470.lbm
plain_train      = 1
power            = 0
preenv           = 1
prefix           = 
...
run              = all
rundir           = run
runspec          = /home/sangeeta/install_archives/bin/runspec --config=Sangeeta-linux.cfg --size=test --noreportable --tune=base --iterations=1 lbm
safe_eval        = 1
...
srcalt           = 
srcdir           = src
srcsource        = /home/sangeeta/install_archives/benchspec/CPU2006/470.lbm/src
stagger          = 10
