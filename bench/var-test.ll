...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @addmy(double %x, double %y) #0 {
entry:
  %x.addr = alloca double, align 8
  %y.addr = alloca double, align 8
...
entry:
  ...
  %0 = load volatile double, double* %z1, align 8
  %1 = load volatile double, double* %z2, align 8
  %add = fadd double %0, %1
  ...
  %2 = load volatile double, double* %z3, align 8
  %call1 = call double @add(double 6.000000e+00, double %2)
  ...
  store volatile double %add2, double* %z, align 8
  %5 = load volatile double, double* %z, align 8
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), double %5)
  ret i32 0
}
